...
def mostrarGameOver(pontuacaoFinal, janela, fonte):
    colocarTexto('GAME OVER', fonte, janela, LARGURAJANELA / 3, ALTURAJANELA / 3)
    colocarTexto('Pontuação final: ' + str(pontuacaoFinal), fonte, janela, LARGURAJANELA / 3, ALTURAJANELA / 2)
...
while True:
    ...
    while deve_continuar:
        ...
        if verificarColisaoNave(jogador, asteroides):
            somFinal.play()
            mostrarGameOver(pontuacao, janela, fonte)
